...
asm__ cmd is2 cmdData 
   ...
   | (cmd == (extractCmd "MOVDW") && is2 && ((dType (cmdData!!0)) == INT) && ((dType (cmdData!!1)) == REG) && (d (cmdData!!1)) == (getRegIdByStr "ax")) = asmBuild cmd 0 (integerToWord32 (d (cmdData!!0)))
   | (cmd == (extractCmd "MOVDW") && is2 && ((dType (cmdData!!0)) == INT) && ((dType (cmdData!!1)) == REG) && (d (cmdData!!1)) == (getRegIdByStr "bx")) = asmBuild cmd 1 (integerToWord32 (d (cmdData!!0)))
